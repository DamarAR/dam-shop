...
from main.views import show_main, create_food_entry, show_xml, show_json, show_xml_by_id, show_json_by_id, registration, login_user, logout_user, edit_food, delete_food, add_food_entry_ajax
